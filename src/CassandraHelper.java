...
public class CassandraHelper {
    ...
    private String query = "INSERT INTO devkeyspace.plateindex (plate_fragment, plates) VALUES(?, ?)"; 
    ...
    public void addKeyValues(String key, String[] values) {
        ...
        if(key.length()>0) {
            ...
            try {
                BoundStatement boundStatement = this.preparedStatement.bind(key, valuesList);
